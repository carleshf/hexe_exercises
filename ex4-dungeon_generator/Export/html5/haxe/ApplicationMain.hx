...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ex4DungeonGenerator", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Ex4DungeonGenerator", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ex4DungeonGenerator";
		app.meta["name"] = "Ex4DungeonGenerator";
		app.meta["packageName"] = "com.sample.ex4dungeongenerator";
		...
		#elseif air
		app.window.title = "Ex4DungeonGenerator";
		#else
