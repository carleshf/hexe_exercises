...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ex3Storyprompt", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Ex3Storyprompt", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ex3Storyprompt";
		app.meta["name"] = "Ex3Storyprompt";
		app.meta["packageName"] = "com.sample.ex3storyprompt";
		...
		#elseif air
		app.window.title = "Ex3Storyprompt";
		#else
