...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ex5BranchingChoices", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Ex5BranchingChoices", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ex5BranchingChoices";
		app.meta["name"] = "Ex5BranchingChoices";
		app.meta["packageName"] = "com.sample.ex5branchingchoices";
		...
		#elseif air
		app.window.title = "Ex5BranchingChoices";
		#else
