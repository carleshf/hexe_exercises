...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ex2PerlinNoise", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Ex2PerlinNoise", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ex2PerlinNoise";
		app.meta["name"] = "Ex2PerlinNoise";
		app.meta["packageName"] = "com.sample.ex2perlinnoise";
		...
		#elseif air
		app.window.title = "Ex2PerlinNoise";
		#else
