...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ex1Starfield", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Ex1Starfield", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ex1Starfield";
		app.meta["name"] = "Ex1Starfield";
		app.meta["packageName"] = "com.sample.ex1starfield";
