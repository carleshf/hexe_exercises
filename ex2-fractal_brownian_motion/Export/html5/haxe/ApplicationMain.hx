...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ex2FractalBrownianMotion", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Ex2FractalBrownianMotion", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Ex2FractalBrownianMotion";
		app.meta["name"] = "Ex2FractalBrownianMotion";
		app.meta["packageName"] = "com.sample.ex2fractalbrownianmotion";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Ex2FractalBrownianMotion",
			width: 0,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Ex2FractalBrownianMotion";
		#else
